function [A,B,M,N,R,Z] = CalcTSModel_Z_uncertainty(gamma)
    
    ri=8; % # of local models
    z10 = -1; 
    z11 =  1;  
    z20 = -1; 
    z21 =  1;  
...
%                 0,                  0,                0,    gamma(7)];
    ...
    M{1,4}=[gamma(1)*z11 -gamma(3)*z21   0   0
            gamma(1)*z21  gamma(3)*z11   0   0
                 0     0    (1-unc)*gamma(5)   0
                 0     0     0   gamma(7)];
    M{1,5}=[gamma(1)*z10 -gamma(3)*z20   0      0
            gamma(1)*z20  gamma(3)*z10   0      0
                 0          0       (1+unc)*gamma(5)    0
                 0          0           0   gamma(7)];
    M{1,6}=[gamma(1)*z10 -gamma(3)*z21   0   0
            gamma(1)*z21  gamma(3)*z10   0   0
                 0     0    (1+unc)*gamma(5)   0
                 0     0     0   gamma(7)];
    M{1,7}=[gamma(1)*z11 -gamma(3)*z20   0   0
            gamma(1)*z20  gamma(3)*z11   0   0
                 0     0    (1+unc)*gamma(5)   0
                 0     0     0   gamma(7)];
    M{1,8}=[gamma(1)*z11 -gamma(3)*z21   0   0
            gamma(1)*z21  gamma(3)*z11   0   0
                 0     0    (1+unc)*gamma(5)   0
                 0     0     0   gamma(7)];
% ********************************
...
%                 0               0    0   gamma(8)]
    ...
    N{1,5}=[gamma(2)*z10 -gamma(4)*z20  0  0
            gamma(2)*z20  gamma(4)*z10  0  0
               0       0   (1+unc)*gamma(6)  0
               0       0    0 gamma(8)];
    N{1,6}=[gamma(2)*z10 -gamma(4)*z21  0  0
            gamma(2)*z21  gamma(4)*z10  0  0
               0       0   (1+unc)*gamma(6)  0
               0       0    0 gamma(8)];
    N{1,7}=[gamma(2)*z11 -gamma(4)*z20  0  0
            gamma(2)*z20  gamma(4)*z11  0  0
               0       0   (1+unc)*gamma(6)  0
               0       0    0 gamma(8)];
    N{1,8}=[gamma(2)*z11 -gamma(4)*z21  0  0
            gamma(2)*z21  gamma(4)*z11  0  0
               0       0   (1+unc)*gamma(6)  0
               0       0    0 gamma(8)];
% ********************************
